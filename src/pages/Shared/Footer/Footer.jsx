...
import './Footer.css';
import { FaMapPin, FaPhoneAlt, FaRegCommentDots } from 'react-icons/fa';
          ...
          <Row>
            <Col xs={12} md={4}>
              <div className="location">
                <h4>Our Location <FaMapPin></FaMapPin></h4>
            ...
            <Col xs={12} md={4}>
              <div className="contact">
                <h4>Contact Us <FaPhoneAlt></FaPhoneAlt> </h4>
            ...
            <Col xs={12} md={4}>
              <div className="socials">
                <h4 className='ms-4'>Socials <FaRegCommentDots></FaRegCommentDots> </h4>
